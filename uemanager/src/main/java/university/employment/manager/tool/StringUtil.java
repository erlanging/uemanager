...
public class StringUtil {
	...
	public static final boolean isPhoneNum(String phone) {
		return phone.matches("^(((1[3|4|5|7|8][0-9]{1})|159|153)+\\d{8})$");
	}
	
	/**
	 * 
	 * @Title: isEmail 
	 * @Description: 判断一个字符串是否是一个邮箱
	 * @param @param str
	 * @param @return
	 * @return boolean 
	 * @throws
	 */
	public static final boolean isEmail(String mail) {
	...
	public static String ChineseStringToAscii(String s) {
		try {
			...
			// CharToByteConverter.getConverter("GBK");
	...
	public static String ChineseStringToUTF(String s) {
		try {
			// CharToByteConverter toByte =
			// CharToByteConverter.getConverter("UTF-8");
			// byte[] orig = toByte.convertAll(s.toCharArray());
			// char[] dest = new char[orig.length];
			// for (int i = 0; i < orig.length; i++)
			// dest[i] = (char) (orig[i] & 0xFF);
	...
	public static String AsciiToChineseString(String s) {
		...
		try {
			...
			// ByteToCharConverter.getConverter("GBK");
	...
	public static boolean isNotBool(Object str) {
		return !isEmpty(str) && !str.toString().equals("null");
	}
